...
export const TOOLS = [
  ...
  },
  {
    ...
    platforms: ['macos', 'linux', 'windows'],
    install: {
      macos: [{ brew: 'ollama' }, { cask: 'ollama' }],
      linux: { script: 'curl -fsSL https://ollama.com/install.sh | sh' },
      windows: [{ winget: 'Ollama.Ollama' }, { scoop: 'ollama' }],
    },
...
export const PROFILES = {
  ...
  bootcamp: {
    name: 'Bootcamp',
    description: 'First-time setup — Git, Node.js, VS Code, Ollama, Postman',
    ...
    ids: ['git', 'fnm', 'vscode', 'github-cli', 'ollama', 'postman'],
  },
  js: {
    name: 'JavaScript',
